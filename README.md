...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A growing collection of small Shell utilities for repeatable development and system tasks.</p>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>A TypeScript project exploring custom controls and Home Assistant integrations.</p>
      <p><code>TypeScript</code> <code>Home Assistant</code> <code>IoT</code></p>
    </td>
  </tr>
</table>
